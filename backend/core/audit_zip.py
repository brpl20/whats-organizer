    ...
    try:
        ...
        with zipfile.ZipFile(zip_path, 'r') as zip_ref:
            ...
            for file in file_list:
                ...
                compression_relation = {}
                compression_relation[zipfile.ZIP_STORED] = "Stored (no compression)"
                compression_relation[zipfile.ZIP_DEFLATED]= "Deflated"
                compression_relation[zipfile.ZIP_BZIP2]= "BZIP2"
                compression_relation[zipfile.ZIP_LZMA]= "LZMA"

                method_name = compression_relation[compression_method]
